...
app = typer.Typer(help="ChatGPT-driven OKX trading bot")   # ← enables sub-commands
...
@app.command()                                              # ← registers  “trade”
def trade():
    """Interactive trade flow."""
    load_dotenv()
    _check_env()

    okx = OKXClient(os.getenv("OKX_API_KEY"),
    ...
    with ChatGPTInterface() as chat:                         # API key comes from env
